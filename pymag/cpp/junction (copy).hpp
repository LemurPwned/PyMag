...
public:
    ...
    static std::vector<CVector> RK45(CVector mag, CVector m_Top, CVector m_Bottom, CVector Hext, CVector HOe, double dt, int layer, 
                                     double Ms,
                                     double Ku,
                                     double Ju,
                                     CVector Kdir,
                                     ...
                                     double alpha)
    {
        ...
        k1 = Junction::LLG(mag, Hext) *dt;
        k2 = Junction::LLG(mag + k1 * 0.5, Hext) *dt;
        k3 = Junction::LLG(mag + k2 * 0.5, Hext) *dt;
        k4 = Junction::LLG(mag + k3, Hext) *dt;
    ...
    static CVector LLG(CVector mag, CVector Hext)
    {
        ...
        dm = Hprod * -PERGYR + c_cross(mag, Hprod) * 0.001 * -PERGYR;
